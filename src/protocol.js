...
/**
 * Format a 16-byte Uint8Array as a UUID-like identifier string.
...
/**
 * Parse a Trojan protocol request from a buffer.
 * @param {ArrayBuffer} buffer - Raw request data
 * @param {string} passwordPlainText - The plaintext password (UUID)
 * @returns {{ hasError: boolean, message?: string, addressType?: number, port?: number, hostname?: string, rawClientData?: Uint8Array }}
 */
...
/**
 * Parse a VLESS protocol request from a chunk.
 * @param {ArrayBuffer} chunk - Raw request data
 * @param {string} token - Expected UUID token
 * @returns {{ hasError: boolean, message?: string, addressType?: number, port?: number, hostname?: string, isUDP?: boolean, rawIndex?: number, version?: Uint8Array }}
 */
